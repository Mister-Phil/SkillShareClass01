//The resourse used is: remix.ethereum.org

pragma solidity ^0.8.7;
//You need to say the version of sol you want

contract MyContract {
    string value; //THe data will be stored on BKCN
